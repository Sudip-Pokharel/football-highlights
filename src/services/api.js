...
async function __getLeagueTeamDetails(id) {
    const response = await axios.get(`https://www.thesportsdb.com/api/v1/json/1/lookup_all_teams.php?id=${id}`);
    return response.data;
}
